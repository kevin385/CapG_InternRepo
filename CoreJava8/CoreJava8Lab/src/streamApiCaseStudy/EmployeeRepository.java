...
public class EmployeeRepository {
	...
	public static List<Department> getDepartments() {
		...
		dlist.add(new Department(50,"Administration",105));
		return dlist;
	}
	...
	public static List<Employee> getEmployees() {
		...
		elist.add(new Employee(101,"Vinod","Malhotra","vinod@cg.com","7863214020",LocalDate.of(2015,8,2),"HR_Mgr",45000.00,100,new Department(40,"HR",104)));
